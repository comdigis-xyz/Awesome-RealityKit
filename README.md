...
- [HandVector](https://github.com/XanderXu/HandVector) - HandVector uses Cosine Similarity Algorithm to calculate the similarity of hand gestures in visionOS, and with a macOS tool to test hand tracking in visionOS simulator.
